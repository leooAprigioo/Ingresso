...
INSERT INTO filme (id, titulo, data_lancamento, ano, duracao, genero, diretor, atores, sinopse, classificacao, em_cartaz, idioma, pais, imdb, poster, banner, trailer_url) VALUES (13, 'Eduardo e Mônica', '2020-04-02', 2020, 0, 'Romance;Drama', 'René Sampaio', 'Gabriel Leone;Alice Braga;Otávio Augusto','Adaptação para o SeuCinema da famosa canção "Eduardo e Mônica", composta por Renato Russo, sobre um casal que não tinha nada a ver um com o outro mas acabou se apaixonando perdidamente.', 0,1,'Potuguês','Brasil',0,'/iV3qb95qNfBgPWIsobrtUPMKGCo.jpg','/4ECPCD5yx8z2dyauaAeNjseDwfq.jpg','IoSR5tl1AAU');
